  ...
  return (
    ...
    >
      ...
      <div style={ABOVE_WORDS}>
        ...
        <div
          className="absolute top-1/2 left-1/2 aspect-square w-[130vmin] -translate-x-1/2 -translate-y-1/2 rounded-full"
          style={{
        ...
        */}
        <div
          className="relative aspect-[10/7] w-[min(92vw,480px)] shrink-0"
