...
export type CalligraphyId = "bismillah" | "versePairs";
 ...
 * between 0.80 and 0.89. It is a threshold rather than a contrast measurement
 * on purpose — the artwork is pure black or pure white, so whichever side of
 * the middle the background falls, the far end of the scale is the answer.
 */
